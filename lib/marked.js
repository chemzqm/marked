...
Parser.prototype.tok = function() {
  switch (this.token.type) {
    ...
    case 'code': {
      ...
      if (highlight) {
        var code = highlight(this.token.text, this.token.lang, this.options.color);
...
function highlight(code, lang, color){
  if(!hljs) return code;
  ...
  if(color === true && typeof window === 'undefined'){
...
marked.defaults = {
  ...
  smartLists: false,
  silent: false,
  color: (typeof window === 'undefined'?true:false),
  highlight: highlight,
  langPrefix: 'language-'
};
